...
InputControllerData InputController::get_input_data() {
    ...
    input_controller_data.arm_toggle = 
    input_controller_data.steering_mode_toggle = 
    input_controller_data.drive_mode_toggle = 
    input_controller_data.lock_rear_right = 
    input_controller_data.lock_rear_left = 
    ...
    input_controller_data.new_data = 
