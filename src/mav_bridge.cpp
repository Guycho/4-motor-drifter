...
void MavBridge::set_messages_rate()
{
    for (uint8_t i = 0; i < Config::MavlinkBridge::num_messages_per_group; i++)
    {
        ...
        {
            set_message_rate(m_message_group_level_1[i], Config::MavlinkBridge::message_rate_level_1);
        }
    }
    for (uint8_t i = 0; i < Config::MavlinkBridge::num_messages_per_group; i++)
    {
        ...
        {
            set_message_rate(m_message_group_level_2[i], Config::MavlinkBridge::message_rate_level_2);
        }
    }
}
