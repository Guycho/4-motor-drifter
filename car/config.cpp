...
namespace Motor {
namespace Wheel {
const uint8_t pin[Car::num_wheels] = {1, 2, 3, 4};
const uint16_t min_pulse[Car::num_wheels] = {1000, 1000, 1000, 1000};
const uint16_t max_pulse[Car::num_wheels] = {2000, 2000, 2000, 2000};
}  // namespace Wheel
namespace Steering {
const uint8_t pin[Car::num_steering] = {7, 8};
const uint16_t min_pulse[Car::num_steering] = {1000, 1000};
const uint16_t max_pulse[Car::num_steering] = {2000, 2000};
}  // namespace Steering
}  // namespace Motor
